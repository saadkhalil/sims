								...
								<div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
									...
									<div>
										...
										<div class="widget-body no-padding">
											...
											<form class="smart-form" id="edit-form" action="<?php echo base_url()?>admin/accessories/update" method="post" >
												<header>
													Edit <?php echo $Title ?>
												</header>
												...
												<fieldset>
													...
													<div class="row">
														<section class="col col-5">
															...
															<label class="input"> Charges :
																<input type="text" value="<?php echo  $get_data_row->CHARGES ?>" placeholder="Enter Service Charges" name="CHARGES">
																<input type="hidden" name="ID" value="<?php echo $get_data_row->ID?>">
															</label>
														</section>
													</div>
												...
												<footer>
													...
													<button type="button" class="btn btn-default" onclick="LoadAjaxScreen('accessories','view_accessories')">
														Back
													</button>
												</footer>
											</form>
