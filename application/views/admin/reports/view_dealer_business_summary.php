            ...
            <div class="row">
                <div class="col-xs-12 col-sm-7 col-md-7 col-lg-8">
                    <h1 class="page-title txt-color-blueDark">
                        ...
                        <span>>
                            View Dealer Business Summary <?php echo $Title ?>
                        </span>
                    </h1>
                </div>
...
<div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <form class="smart-form" id="dealerbusinesssummary-form"  action="<?php echo base_url()?>admin/reports/filterdealerbusinesssummary">
                                        <header>
                                            Search Parameter
                                        </header>
