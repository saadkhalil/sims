...
<div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <form class="smart-form" id="freeservicedetailfilter-form"  action="<?php echo base_url()?>admin/reports/filterfreeservicedetail" >
                                                ...
                                                <section class="col col-10">
                                                    ...
                                                    <select class="form-control js-example-basic-multiple" name="DEALER_ID" >
                                                      ...
                                                      <?php foreach($get_dealers_data as $dealers){ ?>
                                                         <option value="<?php echo $dealers['ID']?>">    <?php echo $dealers['NAME'].'  - '.$dealers['TITLE']?></option>
                                                      <?php } ?>
                                        ...
                                        <?php } ?>
                                            <div class="row" >
                                                <section class="col col-5">
                                                    ...
                                                    <label class="input">Date From :
                                                        <input type="text" class="form-control datepicker" name="DATE_FROM" readonly="" value="<?php echo date('m/01/Y')?>">
                                                    </label>

                                                </section>
                                                <section class="col col-5">

                                                    <label class="input"> Date To:
                                                        <input type="text" class="form-control datepicker" name="DATE_TO" readonly="" value="<?php echo date('m/d/Y', strtotime(date('m/d/Y'). ' +1 day'))?>">
                                                    </label>
                                    ...
                                    <div class="col-12 col-sm-12" id="showprint">
                                        ...
                                        <img src="<?php echo base_url()?>assets/admin/img/logo.png" style="margin-left: 290px; width: 20%;"  >
                                            <h2 style="text-align: center;">Free Service Detail Report</h2>
                                        </div>
