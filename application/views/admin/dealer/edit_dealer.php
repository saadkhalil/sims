													...
													<div class="row">
														<section class="col col-5">
															...
															<label class="input"> Dealer Name :
																<input type="text" placeholder="Enter Dealer Name" name="NAME" value="<?php echo $get_data_row->NAME?>">
															</label>
														</section>
														<section class="col col-5">
															
															<label class="input"> Email Address :
																<input type="email" placeholder="Enter Email Address" name="EMAIL" value="<?php echo $get_data_row->EMAIL?>">
															</label>
														</section>
													</div>
													<div class="row">
														<section class="col col-5">
															<label class="input"> Dealer Code :
																<input type="text" placeholder="Enter Dealer Code" name="USERNAME" value="<?php echo $get_data_row->USER_NAME?>">
															</label>
														</section><section class="col col-5">
															<label class="input"> Password :
																<input type="text" placeholder="Enter Password"  value="<?php echo $get_data_row->VIEW_PASSWORD?>" name="PASSWORD" >
															</label>
														</section>
													</div>
													<div class="row">
													...
													<div class="row">
														...
														<section class="col col-5">
															<label class="input"> Cell Phone:
																<input type="text" placeholder="Enter Cell Phone No" value="<?php echo $get_data_row->MOBILE?>" class="phone" name="MOBILE" >
															</label>
														</section>
													</div>
													<div class="row">
														<section class="col col-5">
															...
															<input type="text" placeholder="Select Commencement Date" value="<?php echo $get_data_row->COMMENCEMENT_DATE?>" autocomplete="off" class="datepicker" name="COMMENCEMENT_DATE">
																
															</label>
														</section>
														<section class="col col-5">
															<label class="input"> Telephone :
															<input type="text" value="<?php echo $get_data_row->PHONE?>" placeholder="Enter Telephone No" name="PHONE">
													...
													<div class="row">
														...
														<section class="col col-5">
															<label class="input"> Address:
																<textarea class="form-control" name="ADDRESS" rows="4" placeholder="Enter Complete Address"><?php echo $get_data_row->ADDRESS?></textarea>
															</label>
														</section>
													</div>
													<br>
														...
														<section class="col col-3">
															<label class="input"> Length:
																<input type="number" name="WORKSHOP_LENGTH" value="<?php echo $get_data_row->WORKSHOP_LENGTH?>" placeholder="Enter Workshop Length" >
															</label>
														</section>
														<section class="col col-3">
															<label class="input"> Breadth:
																<input type="number" value="<?php echo $get_data_row->WORKSHOP_BREADTH?>" name="WORKSHOP_BREADTH" placeholder="Enter Workshop Breadth" >
															</label>
														</section>
														<section class="col col-3">
															<label class="input"> Number of Lift(s):
																<input type="number" value="<?php echo $get_data_row->LIFTS?>" name="LIFTS" placeholder="Enter Number of Lift(s)" >
															</label>
														</section>
														<section class="col col-3">
															<label class="input"> Number of Pit(s):
																<input type="number" value="<?php echo $get_data_row->PITS?>" name="PITS" placeholder="Enter Number of Pit(s)"  >
															</label>
														</section>
														<br>
														<hr>
														...
														<section class="col col-3">
															<label class="input"> SAP Code(If Exists):
																<input type="text" value="<?php echo $get_data_row->SAP_CODE?>" name="SAP_CODE" placeholder="Enter SAP Code" >
															</label>
														</section>
														<section class="col col-3">
															...
															<label class="label">Workshop Facilities : </label>
																<div class="inline-group">
																	...
																	<label class="checkbox">
																		<input type="checkbox" <?php echo (in_array($workshop['ID'],$workshoparr) ? 'checked': '')?>  value="<?php echo $workshop['ID']?>" name="WORKSHOP[]" >
														...
														<section class="col col-5">
															<label class="input"> Length:
																<input type="number" name="SIGN_LENGTH" value="<?php echo $get_data_row->SIGN_LENGTH?>" placeholder="Enter Signal Length" >
															</label>
														</section>
														<section class="col col-5">
															<label class="input"> Breadth:
																<input type="number" name="SIGN_BREADTH" value="<?php echo $get_data_row->SIGN_BREADTH?>" placeholder="Enter Signal Breadth" >
															</label>
														</section>
														<br>
														<hr>
														...
														<section class="col col-3">
															<label class="input"> Owner's Name:
																<input type="text" name="O_NAME" placeholder="Enter Owner's Name" value="<?php echo $get_data_row->O_NAME?>" >
															</label>
														</section>
														<section class="col col-3">
															<label class="input"> Father Name:
																<input type="text" value="<?php echo $get_data_row->O_FATHER?>" name="O_FATHER" placeholder="Enter Father Name" >
															</label>
														</section>
														<section class="col col-3">
															<label class="input"> Age:
																<input type="number" value="<?php echo $get_data_row->O_AGE?>" name="O_AGE" placeholder="Enter Owner's Age" >
															</label>
														</section>
														<section class="col col-3">
														...
														<section class="col col-3">
															<label class="input"> NIC:
																<input type="text" value="<?php echo $get_data_row->O_NIC?>" class="nic" name="O_NIC" placeholder="Enter Owner's Age" >
															</label>
														</section>
														<section class="col col-3">
															<label class="input"> Mobile Number:
																<input type="text " value="<?php echo $get_data_row->O_MOBILE?>" class="phone"
																name="O_MOBILE" placeholder="Enter Owner's Mobile" >
															</label>
														</section>
														<section class="col col-3">
															<label class="input"> Next of Kin:
																<input type="text" value="<?php echo $get_data_row->O_NXT_KIN?>" name="O_NXT_KIN" placeholder="Enter Next of Kin" >
															</label>
														</section><br><br><br><br><br><br><br><br><hr>	<br>
														<section class="col col-3">
															<label class="input"> NTN:
																<input type="text" value="<?php echo $get_data_row->O_NTN?>"  name="O_NTN" placeholder="Enter NTN No" >
															</label>
														</section>
														<section class="col col-3">
															<label class="input"> Bank:
																<input type="text" value="<?php echo $get_data_row->O_BANK?>" name="O_BANK" placeholder="Enter Bank Name" >
															</label>
														</section>
														<section class="col col-3">
															<label class="input"> Branch:
																<input type="text" value="<?php echo $get_data_row->O_BRANCH?>" name="O_BRANCH" placeholder="Enter Branch Name" >
															</label>
														</section>
														<section class="col col-3">
															<label class="input"> Account No:
																<input type="text" value="<?php echo $get_data_row->O_ACCNO ?>" name="O_ACCNO" placeholder="Enter Account No" >
															</label>
														</section>
														<br>
														<br>
														...
														<section class="col col-3">
															<label class="input"> Monthly Service Incoming:
																<input type="text" value="<?php echo $get_data_row->MON_SER_IN?>" name="MON_SER_IN" placeholder="Enter Monthly Service Incoming" >
															</label>
														</section>
														<section class="col col-3">
															<label class="input"> Initial Parts Investment:
																<input type="text" name="IN_PART_INVEST" value="<?php echo $get_data_row->IN_PART_INVEST?>" placeholder="Enter Initial Parts Investment" >
															</label>
														</section>
														<section class="col col-3">
															<label class="input"> Monthly Committed Parts Target:
																<input type="text" value="<?php echo $get_data_row->MON_COM_PART?>" name="MON_COM_PART" placeholder="Enter Monthly Committed Parts Target" >
															</label>
														</section>
														<br><br>
														<br><br><br>
														...
														<section class="col col-12">
															<label class="label">Devices and Machines : </label>
																<div class="inline-group">
																	...
																	<label class="checkbox">
																		<input type="checkbox" <?php echo (in_array($device['ID'],$devicesarr) ? 'checked': '')?>  value="<?php echo $device['ID']?>" name="DEVICES[]" >
														...
														<section class="col col-12">
															<label class="label">Special Tools : </label>
																<div class="inline-group">
																	...
																	<label class="checkbox">
																		<input type="checkbox" <?php echo (in_array($tool['ID'],$specialsarr) ? 'checked': '')?> value="<?php echo $tool['ID']?>" name="SPECIALTOOLS[]" >
														...
														<section class="col col-12">
															<label class="label">Miscellaneous Tools : </label>
																<div class="inline-group">
																	...
																	<label class="checkbox">
																		<input type="checkbox" <?php echo (in_array($misc['ID'],$miscsarr) ? 'checked': '')?> value="<?php echo $misc['ID']?>" name="MISC[]" >
