<!-- MAIN CONTENT -->
                    ...
                    <article class="col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <form class="smart-form" id="dealerfilter-form"  action="<?php echo base_url()?>admin/dealer/filter" >
        									...
        									<div class="row">
        										<section class="col col-8">
        											...
        											<select class="form-control js-example-basic-multiple" name="DEALER" >
        											  ...
        											  <?php foreach($get_data as $dealers){ ?>
        									...
        									<div class="row">
        										...
        										<div class="row" >
															<footer>
                                                                ...
                                                                <a class="btn btn-danger btn-small" href="javascript:void(0);" onclick="LoadAjaxScreen('dealer','add_dealer')"><i class="fa fa-plus"></i> Add <?php echo $Title?></a>
        ...
        <script type="text/javascript">
                ...
                function deletedealer(id){
                        ...
                        var action="<?php echo base_url();?>admin/dealer/delete";
                                    ...
                                    $.ajax({
                                        ...
                                        success:function(result){
                                            if(result=='deleted'){
                                                ...
                                                $('#dealerfilter-form').trigger('submit');
                                            }
                                            else{
                                                $.smallBox({
