								...
								<div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
									...
									<div>
										...
										<div class="widget-body no-padding">
											...
											<form class="smart-form" id="add-form"  action="<?php echo base_url()?>admin/customer_details/submit" >
													...
													<div class="row">
														...
														<section class="col col-5">
															...
															<label class="input"> Contact(Mobile) No :
																<input type="text" class="phone" placeholder="Enter Contact No" name="CONTACT">
															</label>
														</section>
													</div>
													<div class="row">
														<section class="col col-5">
															...
															<label class="input"> City :
																<select class="form-control js-example-basic-multiple" name="CITY_ID" id="edit_city">
												...
												<div class="row">
														<section class="col col-5">
															<label class="input"> NIC No :
																<input type="text" placeholder="Enter NIC No" class="nic" name="NIC">
															</label>
														</section>
												</div>
