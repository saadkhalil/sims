								...
								<div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
									...
									<div>
										...
										<div class="widget-body no-padding">
											...
											<form class="smart-form" id="edit-form" action="<?php echo base_url()?>admin/visit_type/update" method="post" >
												<header>
													Edit <?php echo $Title ?>
												</header>
													...
													<div class="row">
														<section class="col col-5">
															...
															<label class="input"> Service Name :
																<input type="text" value="<?php echo  $get_data_row->SERVICE_NAME ?>" placeholder="Enter Service Name" name="SERVICE_NAME">
														...
														<section class="col col-5">
															...
															<label class="input"> AVAILABILITY :
																<select class="form-control" name="AVAILABLE">
																	...
																	<option <?php echo ($get_data_row->AVAILABLE==1 ? 'selected' : '')?> value="1">Available</option>
																	<option <?php echo ($get_data_row->AVAILABLE==0 ? 'selected' : '')?> value="0">Not Available</option>
																</select>
															</label>
														</section>
													</div>
