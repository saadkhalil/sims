								...
								<div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
									...
									<div>
										...
										<div class="widget-body no-padding">
											...
											<form class="smart-form" id="edit-form" action="<?php echo base_url()?>admin/color/update" method="post" >
												<header>
													Edit <?php echo $Title ?>
												</header>
												...
												<footer>
													...
													<button type="button" class="btn btn-default" onclick="LoadAjaxScreen('color','view_color')">
														Back
													</button>
												</footer>
											</form>
